...
import 'package:apple_grower/features/forms/consignmentForm/biltydownloadandshare.dart' as btds;
                            ...
                            Expanded(
                              child: ElevatedButton(
                                onPressed: () async {
                                 ...
                                 await btds.downloadBiltyAadhati( remark: "", packhouseName: controller.packHouseName.value,consignmentNo: controller.searchId.value ,controller.bilty.value,growerName: controller.growerName.value,ladaniName: controller.highestBidder.value, websiteUrl: "https://bookmyloadindia.com");
                                },
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    SizedBox(
                      height: 400,
                      child: // --- Using the new reusable chart widget ---
                          Obx(
                        () => DynamicBarLineChart(
                    ...
                    ExpansionTile(title: Text("Show Graphs"), children: [
                      BiltyQualityDonutCharts(
                          categoryData: controller.bilty.value.categories)
                    ]),
              ...
              Padding(
                ...
                child: Obx(() => Row(
                      children: [
                        ...
                        RadioMenuButton(
                          value: "Gadd",
                          groupValue: controller.biddingType1.value,
                          toggleable: false,
                          onChanged: null, // <- disables the button
                          style: ButtonStyle(
                            foregroundColor:
              ...
              Padding(
                ...
                child: Obx(() => Row(
                      children: [
                        ...
                        RadioMenuButton(
                          value: "Per Kg",
                          groupValue: controller.biddingType2.value,
                          onChanged: (value) {
                            controller.biddingType2.value = value!;
                          },
                          child: Text("Per Kg"),
                        ),
                        RadioMenuButton(
