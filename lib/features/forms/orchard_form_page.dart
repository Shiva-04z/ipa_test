  ...
  void submitForm() {
    ...
    try {
      final newOrchard = Orchard(
        ...
        expectedHarvestDate: expectedHarvestDate.value ?? DateTime.now() ,
...
class OrchardFormPage extends StatelessWidget {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // _buildBoundarySectionRow(context),
                  // const SizedBox(height: 24),
  ...
  //                             physics: controller.isDrawingBoundary.value ? NeverScrollableScrollPhysics() : null,
  //                             child: _buildBoundarySection(context),
  //                           ),
  //                         )
  //                     ),
  //                   );
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: SizedBox(
          ...
          child: Obx(
            () => SingleChildScrollView(
              physics: controller.isDrawingBoundary.value ? NeverScrollableScrollPhysics() : BouncingScrollPhysics(),
              child: Stack(
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      const Text(
                        'Take a screenshot after boundary marking',
                        style: TextStyle(
                          fontSize: 16,
                          color: Colors.grey,
                        ),
                  ...
                  Obx(() {
                    ...
                    return LayoutBuilder(
                      builder: (context, constraints) {
                        ...
                        bool isMediumWide = constraints.maxWidth > 600;
                        return Column(
                          children: [
                            SizedBox(
                              height:isMediumWide? 100 : isWide ? 150 : 180,
                            ),
                            SizedBox(
